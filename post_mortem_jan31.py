...
# -*- coding: utf-8 -*-
"""
POST-MORTEM ANALYSIS: January 31, 2026
Wheel System - Week 7 (12 tickets played)
"""
...
# Actual results
lotto_result = [1, 16, 27, 32, 34, 39]
lotto_reserve = 38
xl_result = [1, 11, 13, 21, 39, 45]
xl_reserve = 36
...
print("=" * 80)
print("POST-MORTEM: JANUARY 31, 2026 - WHEEL SYSTEM (WEEK 7)")
print("=" * 80)
...
print(f"\n{'=' * 80}")
print("CUMULATIVE PERFORMANCE (Weeks 5-7):")
print(f"{'=' * 80}")
print("Week 5 (Jan 17): XL guarantee activated (4 hits) → €43 won | -€5 net")
print("Week 6 (Jan 24): 0 hits → €0 won | -€36 net")
print("Week 7 (Jan 31): Lotto 1 hit, XL 2 hits → €0 won | -€36 net")
print("─" * 80)
print(f"Total: €43 won | Cost: €120 | Net: -€77")
