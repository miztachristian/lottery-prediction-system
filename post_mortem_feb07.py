...
# -*- coding: utf-8 -*-
"""
POST-MORTEM ANALYSIS: February 7, 2026
Wheel System - Week 8 (12 tickets played)
"""

# Actual results
lotto_result = [5, 8, 19, 32, 36, 44]
lotto_reserve = 41
xl_result = [5, 6, 8, 22, 35, 43]
xl_reserve = 34
...
print("=" * 80)
print("POST-MORTEM: FEBRUARY 7, 2026 - WHEEL SYSTEM (WEEK 8)")
print("=" * 80)
...
print(f"\n{'=' * 80}")
print("CUMULATIVE PERFORMANCE (Weeks 5-8):")
print(f"{'=' * 80}")
print("Week 5 (Jan 17): XL 4 hits → GUARANTEE ✓ → €43 won | net -€5")
print("Week 6 (Jan 24): 0 hits → €0 won | net -€36")
print(f"Week 7 (Jan 31): XL 2 hits → €2 won | net -€34")
print(f"Week 8 (Feb  7): Lotto {len(lotto_hits_from_wheel)} hits, XL {len(xl_hits_from_wheel)} hits → €{total_cash} won | net €{total_cash - 36}")
print("─" * 80)
prev_won = 43 + 0 + 2
prev_cost = 48 + 36 + 36
...
print(f"\nGuarantee activations: 1 in 4 weeks (expected ~1 per 14 weeks)")
