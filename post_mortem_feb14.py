...
# -*- coding: utf-8 -*-
"""
POST-MORTEM ANALYSIS: February 14, 2026
Wheel System - Week 9 (12 tickets played)
"""

# Actual results
lotto_result = [10, 13, 19, 20, 23, 29]
lotto_reserve = 36
xl_result = [6, 8, 11, 14, 29, 43]
xl_reserve = 19
...
print("=" * 80)
print("POST-MORTEM: FEBRUARY 14, 2026 - WHEEL SYSTEM (WEEK 9)")
print("=" * 80)
...
print(f"\n{'=' * 80}")
print("CUMULATIVE PERFORMANCE (Weeks 5-9):")
print(f"{'=' * 80}")
...
print(f"Week 9  (Feb 14): L {len(lotto_hits_from_wheel)}, XL {len(xl_hits_from_wheel)} hits → €{total_cash} won | net €{total_cash - 36}")
print("─" * 80)
prev_won = 43 + 0 + 2 + 3
prev_cost = 48 + 36 + 36 + 36
total_won = prev_won + total_cash
total_cost = prev_cost + 36
print(f"TOTAL: €{total_won} won | €{total_cost} cost | Net: €{total_won - total_cost}")
print(f"\nGuarantee activations: 1 in 5 weeks (expected ~1 per 14 weeks)")
